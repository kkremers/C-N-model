...
head(data.assim)
data.compare1 = data.assim[,c(1,10,11)] #pull out columns for data that you want to assimilate
...
sigma.obs1[!is.na(data.compare1[,2]),2] = 0.04
sigma.obs1[,3] = 0.35*data.compare1[,3]
...
save.image(file="Step1_NEE_NDVI.Rdata")
