...
plot(out$Biomass_C~out$time, type="l", col="red", main = "Biomass C", xlab="", ylab="g C m-2", ylim=c(400, 800))
points(out1$Biomass_C~out1$time, col="gray1", cex=0.25)
plot(out$Biomass_N~out$time, type="l", col="red",  main = "Biomass N", xlab="", ylab="g N m-2", lty=2, ylim=c(4, 6))
points(out1$Biomass_N~out1$time, col="gray1", cex=0.25)
plot(out$Litter_C~out$time, type="l", col="red", main = "Litter C", xlab="", ylab="g C m-2", ylim=c(0, 250))
points(out1$Litter_C~out1$time, col="gray1", cex=0.25)
plot(out$Litter_N~out$time, type="l", col="red", main = "Litter N", xlab="", ylab="g N m-2", lty=2, ylim=c(0, 2.5))
points(out1$Litter_N~out1$time, col="gray1", cex=0.25)
plot(out$SOM_C~out$time, type="l", col="red", main = "SOM C", xlab="", ylab="g C m-2", ylim=c(1800, 2200))
points(out1$SOM_C~out1$time, col="gray1", cex=0.25)
plot(out$SOM_N~out$time, type="l", col="red", main = "SOM N", xlab="Time (days)", ylab="g N m-2",lty=2, ylim=c(55, 59))
